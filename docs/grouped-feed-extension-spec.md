...
8. 作为用户，我可以使用默认“全部”分组聚合浏览所有分组，并一键“全部已阅”。
...
- 在 VideoCard 右下角新增可点击“已阅对勾”，用于不跳转页面就地标记已阅。
- 对勾状态：
  - 已阅：绿色；
  - 未阅：灰色；
  - hover：颜色加深。
...
19. “全部”分组工具栏支持“全部已阅”，会批量写入所有启用分组的已阅时间点。
20. 分组支持“忽略 unread 计数”开关；开启后该分组红点固定为 0。
21. 作者支持“忽略 unread 计数”开关（跨组共享）；开启后该作者视频不参与任何 unread 计算。
22. VideoCard 右下角提供可点击“已阅对勾”，与“已看完”并存；已阅视频不计入 unread。
23. 作者级已阅时间点跨组共享，且优先级绝对高于分组基线；可通过右键竖线清除。
